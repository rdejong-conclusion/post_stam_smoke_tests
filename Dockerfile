...
CMD (service xvfb start; export DISPLAY=:10;export PATH="$PATH:/root/firefox/";cd /root/selenium_wd_tests/;target_host="$target_host" target_user="$target_user" target_pass="$target_pass" ruby post_stam_smoketest_o8_ruby_webdriver)
